...
<body> <div class="navbar navbar-inverse navbar-fixed-top " >
 ...
 <!-- Navigation -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea id="form_message" name="message" class="form-control" placeholder="Your complaint here........ *" rows="4" required="required" data-error="Please,leave us a message."></textarea>
                    <div class="help-block with-errors"></div>
                </div>
            </div>
            <div class="col-md-12">
                <input type="submit" name="complaint" class="btn btn-success btn-send" value="Post"><input type="reset" class="btn btn-success btn-send"value="RESET">
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <p class="text"><strong>*</strong> These fields are required.</p>
            </div>
        </div>
    </div>
  ...
  if(isset($_POST['complaint'])){
    ...
    $querry="INSERT INTO complaints(firstName,lastName,mailId,phone,complaints) VALUES ('$fname','$lname','$mail','$phoneNo','$compl')";
