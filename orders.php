...
<body> <div class="navbar navbar-inverse navbar-fixed-top " >
 ...
 <!-- Navigation -->
   ...
   <!-- Parts --><section id="parts">
    ...
    <div class="controls">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <input type="submit" name="order" class="btn btn-success btn-send" value="Post"><input type="reset" class="btn btn-success btn-send"value="RESET">
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
  ...
  if(isset($_POST['order'])){
    ...
    $querry="INSERT INTO oderstable(firstName,lastName,mailId,phone,preorders) VALUES ('$fname','$lname','$mail','$phoneNo','$compl')";
