        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Orders</h2>   
                        <h5>View your customer's orders here. </h5>
                    </div>
                </div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
            <?php
  $result=mysqli_query($conn,"SELECT*from oderstable") or die(mysqli_error($conn));
  while($query_row=mysqli_fetch_assoc($result))
            { 
              $Id=$query_row['id'];
              ...
              $compl=$query_row['preorders'];
                ...
                echo "<tr>
                    ...
                    <td>".$lName."</td>
                            <td> <a href=           
https://mail.google.com/mail/?view=cm&fs=1&to=".$mailId."&su=DigitalElectronics&body=Yourmessagehere> ".$mailId."</a></td>
                    <td>".$phone."</td>
                    <td>".$compl."</td>
                    </tr>";
            } 
